...
\begin{itemize}
	...
	\item \textbf{Use Case}
	\\The use case shows the outline on how the user will interact with the SeaXChange App. It followed the major stages or participants in the tuna supply chain. Figure~\ref{fig:usecase} shows the use case diagram for SeaXChange.
	\begin{enumerate}
		\item \textbf{Fisher}
